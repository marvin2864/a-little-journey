export type StoryTheme =
  'morning' | 'journey' | 'japan' | 'sakura' | 'snow' | 'night' | 'ending';

export type TransitionType =
  'fade' | 'dissolve' | 'pink-to-blue' | 'blue-to-navy' | 'dark-to-cream';
...
export type StoryScene = {
  ...
  /** Fallback hold time before auto-scroll advances, in seconds. The scene's
   * real video duration wins once the browser has read it. */
  duration: number;
...
export type AppPhase = 'intro' | 'loading' | 'playing';
